...
const Services = () => {
  ...
  return (
    <Section
      title="Services X"
      subtitle="Here are all the services that I provide to my clients.I hope I offer the service that you are looking for. If you don't find something that you are looking for than please send me an email"
    >
